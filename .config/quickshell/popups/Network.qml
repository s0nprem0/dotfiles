...
PopupPanel {
    ...
    function connectToNetwork(network) {
        if (!network || network.ssid === root.activeSsid || root.connecting || connectProc.running)
            return ;
    ...
    function submitPassword(pwd) {
        if (!pwd || pwd.trim() === "" || !root.pendingSsid)
            return ;
        ...
        Item {
            ...
            Column {
                ...
                Column {
                    ...
                    Text {
                        text: root.connecting ? "Connecting…" : (root.connected ? "Wi-Fi Connected" : "Wi-Fi Disconnected")
                        color: Theme.fg
                            ...
                            delegate: Rectangle {
                                ...
                                Text {
                                    ...
                                    MouseArea {
                                        ...
                                        cursorShape: Qt.PointingHandCursor
                                        onClicked: {
                                            root.runAction(modelData.active ? ["nmcli", "connection", "down", modelData.name] : ["nmcli", "connection", "up", modelData.name]);
                                        }
                                    }
                            ...
                            Rectangle {
                                ...
                                Text {
                                    ...
                                    text: {
                                        ...
                                        for (var i = 0; i < 5; i++) s += "<font color='" + (i < bars ? on : off) + "'>█</font>"
                                        return s;
                                    }
                                }
