                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        RowLayout {
                            ...
                            Item { width: 28; height: 28; Text { anchors.centerIn: parent; text: root.wifiEnabled ? "󰖩" : "󰖪"; color: Theme.muted; font.family: Theme.fontFamily; font.pixelSize: 16 } MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: { if (NetworkState.popup) NetworkState.popup.showPopup = !NetworkState.popup.showPopup; win.closeAnim() } } }
