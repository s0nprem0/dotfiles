...
PopupPanel {
    ...
    function switchMediaSource() {
        if (root.mediaSwitching || root.availablePlayers.length <= 1)
            return ;
    ...
    Process {
        ...
        onExited: {
            ...
            try {
                ...
                if (root.hasPlayer && players.length > 0 && players.indexOf(root.playerName) === -1)
            ...
            Column {
                ...
                Column {
                    ...
                    Row {
                        ...
                        Item {
                            width: parent.width - childrenRect.width - muteSysText.width
                            height: 1
                        }
                        ...
                        MouseArea {
                            ...
                            onPositionChanged: {
                                if (pressed) {
                                    ...
                                    if (Math.abs(v - root.sysVol / 100) > 0.02)
                                        root.setSysVol(v);
                    ...
                    Column {
                        ...
                        Row {
                            ...
                            Item {
                                width: parent.width - childrenRect.width - muteMicText.width
                                height: 1
                            }
