...
-- Helper shortcuts for executing commands
...
hl.bind(mainMod .. " + SPACE", exec(menu), { description = "App launcher" })
...
hl.bind(
	mainMod .. " + B",
	exec("rofi -show bt -theme ~/.config/rofi/bluetooth.rasi"),
